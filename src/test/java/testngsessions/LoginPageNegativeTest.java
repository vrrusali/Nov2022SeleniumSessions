...
public class LoginPageNegativeTest {
	...
	/*
	 * public boolean RegForm(String fn, String ln, String email, String phone, String password) {

Write test steps to fill the registration form and click Continue
	...
	/*@Test(dataProvider = "getLoginNegativeData", priority=1, expectedExceptions=ArithmeticException.class, dependonMethod=)*/
